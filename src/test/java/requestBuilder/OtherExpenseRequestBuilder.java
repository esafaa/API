...
public class OtherExpenseRequestBuilder {

    private String name;
    private String amount;
    private String expenseDateTime;
    private String expenseType;
    private String otherExpenseNameId;
    ...
    public String getOtherExpenseNameId() {
        return otherExpenseNameId;
    }

    public void setOtherExpenseNameId(String otherExpenseNameId) {
